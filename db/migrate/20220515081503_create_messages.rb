class CreateMessages < ActiveRecord::Migration[6.0]
  def change
    create_table :messages do |t|
      ...
      t.integer :root_id # Message への外部キー
      t.integer :parent_id # Message への外部キー
    ...
    add_index :messages, %i[type customer_id]
    add_index :messages, %i[customer_id discarded created_at]
    add_index :messages, %i[type staff_member_id]
    add_index :messages, %i[customer_id deleted created_at]
    add_index :messages,
              %i[customer_id deleted status created_at],
